class Packet:
    ...
    def compute_waiting_time(self):
        return self.service_time - self.arrival_time if self.service_time is not None else None
    
    def compute_server_occupation_time(self):
        return self.departure_time - self.service_time if self.departure_time is not None and self.service_time is not None else None 
